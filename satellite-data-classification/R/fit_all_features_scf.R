...
write.csv(accuracies.CV, paste0(path,"extra/results_CV_all_features_scf.csv"))
...
write.csv(accuracies.final, paste0(path,"extra/results_final_all_features_scf.csv"))
...
write.csv(roc.final, paste0(path,"extra/roc_all_features_scf.csv"))
...
write.csv(auc.final, paste0(path,"extra/auc_all_features_scf.csv"))
...
for(image.num in 1:3){
  ...
  ggarrange(rf.plot, svm.plot, lr.plot, ncol = 3, 
    ...
    ggsave(paste0(path, "extra/all-prediction-img", image.num, ".png"), 
...
ggarrange(p[[1]], p[[2]], p[[3]], ncol = 3, 
          common.legend = TRUE, legend = "right") + 
  ggsave(paste0(path, "extra/rf-all-final-prediction.png"), 
         scale = 1, width = 20, height = 6)
...
ggarrange(p[[1]], p[[2]], p[[3]], ncol = 3, 
          common.legend = TRUE, legend = "right") + 
  ggsave(paste0(path, "extra/rf-all-prediction-mismatch.png"), 
         scale = 1, width = 20, height = 6)
